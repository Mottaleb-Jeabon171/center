    			...
    			<?php
    				...
    				if($result && $row_number > 0){
						...
						echo "<tr>";
			    		    ...
			    		    echo "<th style='border: 1px solid #777 !important;'>মোট গাড়ীঃ</th>";
			    			echo "<th style='border: 1px solid #777 !important;'>মোট খালাস খরচঃ</th>";
    					...
    					while($row = $result->fetch_assoc()){
						    ...
						    //Start GB Bank Ganti
						        ...
						        if($result3->num_rows > 0){
						            while($row3 = $result3->fetch_assoc()){
						                $gb_bank_ganti = $row3['debit'];
						                $gb_bank_ganti_db_id = $row3['id'];
						...
						//Start Total para/mot_mul_khoros_shoho
							...
							// echo "<tr>";
							// echo "<td style='border: 1px solid #777 !important; text-align: right;'>মোট</td>";
						    // echo "<td style='border: 1px solid #777 !important;'>".$total_credit." টাকা</td>";
							// echo "</tr>";
                            // echo "<td  style='border: 1px solid #777 !important;'>".$i."</td>";
							// echo "<td style='border: 1px solid #777 !important;'></td>";	    						
